...
import com.spring.example.payload.response.ExceptionResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleMalformedJwtException(MalformedJwtException e, WebRequest w) {
        String url = ((ServletWebRequest) w).getRequest().getRequestURI();
        ExceptionResponse errorExceptions = new ExceptionResponse(HttpStatus.UNAUTHORIZED.value(), HttpStatus.UNAUTHORIZED.getReasonPhrase(), url, new Date(), e.getMessage());
        return new ResponseEntity<>(errorExceptions, HttpStatus.UNAUTHORIZED); // 401
    }
    ...
    public ResponseEntity<ExceptionResponse> handleExpiredJwtException(ExpiredJwtException e, WebRequest w) {
        String url = ((ServletWebRequest) w).getRequest().getRequestURI();
        ExceptionResponse errorExceptions = new ExceptionResponse(HttpStatus.UNAUTHORIZED.value(), HttpStatus.UNAUTHORIZED.getReasonPhrase(), url, new Date(), e.getMessage());
        return new ResponseEntity<>(errorExceptions, HttpStatus.UNAUTHORIZED); // 401
    }
    ...
    public ResponseEntity<ExceptionResponse> handleUnsupportedJwtException(UnsupportedJwtException e, WebRequest w) {
        String url = ((ServletWebRequest) w).getRequest().getRequestURI();
        ExceptionResponse errorExceptions = new ExceptionResponse(HttpStatus.UNAUTHORIZED.value(), HttpStatus.UNAUTHORIZED.getReasonPhrase(), url, new Date(), e.getMessage());
        return new ResponseEntity<>(errorExceptions, HttpStatus.UNAUTHORIZED); // 401
    }
    ...
    public ResponseEntity<ExceptionResponse> handleJwtException(JwtException e, WebRequest w) {
        String url = ((ServletWebRequest) w).getRequest().getRequestURI();
        ExceptionResponse errorExceptions = new ExceptionResponse(HttpStatus.UNAUTHORIZED.value(), HttpStatus.UNAUTHORIZED.getReasonPhrase(), url, new Date(), e.getMessage());
        return new ResponseEntity<>(errorExceptions, HttpStatus.UNAUTHORIZED); // 401
    }
